...
import { requestMagicLinkAction } from "@/features/auth/server/actions";
            ...
            <form onSubmit={handleEmailSignIn} className="space-y-4">
              ...
              {status === "sent" && !error && (
                <p className="text-sm text-emerald-600" role="status">
                  ...
                  instructions in the email to complete sign-in{expiresInMinutes ? ` (expires in ${expiresInMinutes} minute${expiresInMinutes === 1 ? "" : "s"}).` : "."}
                </p>
              )}
