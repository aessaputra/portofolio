...
import GridIcon from "@/components/admin/icons/grid.svg";
import PageIcon from "@/components/admin/icons/page.svg";
        ...
        <li key={nav.name}>
          {nav.subItems ? (
            ...
            >
              ...
              >
                <img src={nav.icon} alt={nav.name} className="w-5 h-5" />
              </span>
